            ...
            <div className="h-64 bg-black relative mb-20">
                ...
                <div className="absolute bottom-0 left-0 w-full translate-y-12">
                    <div className="container mx-auto px-4 flex flex-col md:flex-row items-end md:items-end gap-6">
                        <div className="w-32 h-32 md:w-48 md:h-48 bg-gray-200 rounded-xl border-4 border-white shadow-xl flex items-center justify-center shrink-0 relative overflow-hidden">
                            {nominee.photoUrl ? (
                                <Image src={nominee.photoUrl} alt={nominee.name} fill className="object-cover" />
                            ) : (
                ...
                <div className="md:col-span-2 space-y-8 animate-fade-in">
                    ...
                    <section>
                        ...
                        <ul className="space-y-3">
                            {nominee.achievements?.split('\n').filter(Boolean).map((achievement: string, i: number) => (
