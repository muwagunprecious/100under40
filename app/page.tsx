...
import { ArrowRight, Star, Users, Award, Calendar, Globe, Zap, Target, Heart, BookOpen, Sprout, Radio, Check } from 'lucide-react';
...
export default function Home() {
  return (
    <div className="bg-[#050505] min-h-screen text-white selection:bg-[var(--primary)] selection:text-black">
      ...
      {/* ================= TICKETING SECTION ================= */}
      <section className="py-32 bg-[#0A0A0A] border-t border-white/5" id="tickets">
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="text-center mb-16">
            <span className="badge-label">Awardee Participation</span>
            <h2 className="text-3xl md:text-5xl text-white font-black">Choose Your Experience</h2>
            <p className="mt-4 max-w-2xl mx-auto text-lg">Select a participation tier for the award ceremony. Each package is tailored to maximize your recognition, networking, and celebration.</p>
          </div>
